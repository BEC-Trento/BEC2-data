...
def program(prg, cmd):
    ...
    prg.add(250190600, "Picture Na_4Gdet", functions=dict(time=lambda x: x + cmd.get_var('TOF'), funct_enable=False), enable=False)
    prg.add(250190600, "Picture Na_4Gdet_hamamatsu", enable=False)
    prg.add(250190600, "Picture Na_2Gdet_hamamatsu", enable=False)
    prg.add(250190600, "Picture Na_resonant_hamamatsu")
    prg.add(250190600, "Picture Na_2Gdet", enable=False)
    prg.add(250190600, "Picture Na_1Gdet", enable=False)
    prg.add(250190600, "Picture Na_0Gdet", enable=False)
    prg.add(255190600, "Set_MOT")
    prg.add(255190600, "Set_BrightMOT", enable=False)
    return prg
def commands(cmd):
    import numpy as np
