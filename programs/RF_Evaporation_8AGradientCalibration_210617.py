...
def program(prg, cmd):
    ...
    prg.add(130681850, "MT_Compression")
    prg.add(133181850, "Evaporation Ramp.sub")
    prg.add(218181850, "Config field OFF")
    prg.add(218182850, "Picture Na_2Gdet_offset", enable=False)
    prg.add(218182850, "Picture Na_1Gdet_offset", enable=False)
    prg.add(218182850, "Picture Na_05Gdet_offset", enable=False)
    prg.add(218182850, "Picture Na_offset")
    prg.add(222288449, "Set MOT")
    return prg
