...
def program(prg, cmd):
    ...
    prg.add(170143350, "Config field OFF", enable=False)
    prg.add(170143850, "Dimple_Evaporation")
    prg.add(230153850, "AOM IR Horizontal freq", 120.00)
    prg.add(230193850, "Picture Na_2Gdet_offset", enable=False)
    prg.add(230193850, "Picture Na_1Gdet_offset", enable=False)
    prg.add(230193850, "Picture Na_05Gdet_offset", enable=False)
    prg.add(230193850, "Picture Na_offset")
    prg.add(240048500, "Set MOT")
    return prg
