...
def program(prg, cmd):
    ...
    prg.add(211638500, "IGBT BCompz CLOSE")
    prg.add(211639000, "DAC BCompZ", 0.1000)
    ...
    prg.add(228170000, "Picture Levit_SG at 0ms - Levit 10 ms 10_2018")
    prg.add(228170000, "Picture Levit_SG at 0ms - Levit 20 ms 10_2018", enable=False)
