...
def program(prg, cmd):
    ...
    prg.add(-1000, "TTL uW 2 ON", functions=dict(time=lambda x: x - cmd.get_var('uW_pulse')))
    ...
    prg.add(5020000, "AOM Probe Amp ch1 (+)", 1000)
    prg.add(5030000, "AOM Probe Amp ch2 (-)", 1000)
    return prg
