...
def program(prg, cmd):
    ...
    prg.add(97899, "MT Current Ramp", start_t=0, stop_x=-0.5, n_points=200, start_x=18, stop_t=500, functions=dict(stop_x=lambda x: cmd.get_var('MT_I_decoherence')))
    ...
    prg.add(6101000, "MT Current Ramp", start_t=0, stop_x=-0.5, n_points=50, start_x=0, stop_t=400, functions=dict(start_x=lambda x: cmd.get_var('MT_I_decoherence')))
