...
def program(prg, cmd):
    ...
    prg.add(250, "DDS41_setfull", ch1_freq=100808785.000, ch0_amp=100, ch0_freq=100443733.000, ch0_phase=8000.000, ch1_phase=0.000, ch1_amp=150, functions=dict(ch0_phase=lambda x: cmd.get_var('beat_phase')))
