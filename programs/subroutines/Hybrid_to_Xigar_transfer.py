...
def program(prg, cmd):
    ...
    prg.add(20000, "DAC IR Horizontal ramp", start_t=0, stop_x=0.03, n_points=500, start_x=0.04, stop_t=1000, enable=False)
    prg.add(50000, "AOM IR Vertical Amp", 1000, enable=False)
    prg.add(50500, "AOM IR Vertical freq", 80.00, enable=False)
    prg.add(51500, "DAC IR Vertical ramp", start_t=0, stop_x=-0.1, n_points=100, start_x=1, stop_t=1000, enable=False)
