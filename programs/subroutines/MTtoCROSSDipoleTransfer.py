...
def program(prg, cmd):
    ...
    prg.add(500, "DAC IR Vertical ramp", start_t=0, stop_x=0.08, n_points=400, start_x=-0.1, stop_t=1000)
    prg.add(10010500, "DAC BCompZ", 0.0000)
    prg.add(10010511, "DAC IR Horizontal ramp", start_t=0, stop_x=0.1, n_points=100, start_x=0.04, stop_t=1000, enable=False)
    ...
    prg.add(20011700, "Relay Helm OPEN")
    return prg
