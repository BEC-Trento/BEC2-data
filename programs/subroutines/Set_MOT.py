...
def program(prg, cmd):
    ...
    prg.add(13000, "AOM Probe Amp ch1 (+)", 1000)
    prg.add(16000, "AOM Probe Amp ch2 (-)", 1000)
    ...
    prg.add(34000, "AOM 3DMOT Amp ch2 (-)", 300, functions=dict(amplitude=lambda x: cmd.get_var('amp'), funct_enable=False))
    prg.add(37000, "AOM 3DMOT Detuning", -19.000, functions=dict(frequency=lambda x: cmd.get_var('det'), funct_enable=False))
    prg.add(40000, "AOM Push Amp ch1 (+)", 175)
    prg.add(43000, "AOM Push Amp ch2 (-)", 200)
    prg.add(46000, "AOM Push Detuning", 12.000)
    ...
    prg.add(73000, "AOM GM Detuning", 40.000)
