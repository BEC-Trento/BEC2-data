...
def program(prg, cmd):
    ...
    prg.add(1500, "DS + RepMot amp ramp", start_t=0, stop_x=600, n_points=30, start_x=900, stop_t=23)
    prg.add(246000, "DS + RepMot amp ramp", start_t=0, stop_x=1, n_points=4, start_x=600, stop_t=0.4)
    return prg
