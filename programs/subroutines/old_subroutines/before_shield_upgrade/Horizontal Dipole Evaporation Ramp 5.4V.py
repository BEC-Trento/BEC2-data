...
def program(prg, cmd):
    ...
    prg.add(0, "DAC IR Horizontal ramp", start_t=0, stop_x=1, n_points=200, start_x=5.4, stop_t=2500)
    ...
    prg.add(47500000, "DAC IR Horizontal ramp", start_t=0.05, stop_x=0.04, n_points=100, start_x=0.11, stop_t=1750)
    return prg
