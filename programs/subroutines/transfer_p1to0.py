...
prg_version = "0.7"
def program(prg, cmd):
    prg.add(-2000, "DDS41_setfull", ch0_amp=1, ch0_freq=80000000.000, ch1_freq=100808400.000, ch0_phase=0.000, ch1_phase=0.000, ch1_amp=1000, functions=dict(time=lambda x: x-  cmd.get_var('uW_pulse_p10')))
