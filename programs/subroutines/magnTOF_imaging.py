...
def program(prg, cmd):
    ...
    prg.add(-3500, "AOM Probe Amp ch1 (+)", 1000)
    prg.add(-3000, "AOM Probe Amp ch2 (-)", 1000)
    ...
    prg.add(8500, "TTL Picture Hamamatsu  ON", 'PTAI_m1')
    prg.add(9550, "transfer_p1to0", enable=False)
    prg.add(10300, "TTL Picture Hamamatsu OFF")
    prg.add(10400, "transfer_m1to0")
