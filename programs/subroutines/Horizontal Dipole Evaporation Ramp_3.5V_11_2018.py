...
prg_version = "0.7"
def program(prg, cmd):
    prg.add(0, "DAC IR Horizontal ramp", start_t=0, stop_x=1, n_points=200, start_x=4.5, stop_t=1500)
    ...
    prg.add(27500000, "DAC IR Horizontal ramp", start_t=0.05, stop_x=0.04, n_points=100, start_x=0.11, stop_t=500)
    return prg
