...
def program(prg, cmd):
    ...
    prg.add(1450000, "BCompZ current ramp", start_t=0, stop_x=0.0, n_points=10, start_x=8, stop_t=10, functions=dict(stop_x=lambda x: cmd.get_var('bfin'), funct_enable=False))
    prg.add(1560000, "IGBT Bcompz OPEN")
