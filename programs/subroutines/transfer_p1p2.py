...
def program(prg, cmd):
    ...
    prg.add(-5000, "DDS41_setfull", ch1_freq=104364107.000, ch0_amp=0, ch0_freq=80000000.000, ch0_phase=0.000, ch1_phase=0.000, ch1_amp=1000, functions=dict(time=lambda x: x - cmd.get_var('uW_pulse_p1p2')))
