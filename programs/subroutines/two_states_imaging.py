...
def program(prg, cmd):
    ...
    prg.add(-210, "transfer_p1p2")
    prg.add(-200, "transfer_m1m2", enable=False)
    ...
    prg.add(34700, "transfer_p1p2", enable=False)
    prg.add(34800, "transfer_m1m2")
    prg.add(35000, "Probe_pulse_Hamam")
    prg.add(40200, "Switch Off Dipole", enable=False)
    prg.add(44000, "wait")
    prg.add(100000, "Probe_pulse_Hamam")
    prg.add(150000, "TTL Picture Hamamatsu  ON")
    prg.add(152000, "TTL Picture Hamamatsu OFF")
    return prg
