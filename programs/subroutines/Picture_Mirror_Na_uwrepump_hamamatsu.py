...
def program(prg, cmd):
    ...
    prg.add(-50000, "DAC uW 2/4 Power", 5.0000, enable=False)
    prg.add(-15000, "TTL uW 2 ON")
    prg.add(-10000, "TTL uW 2 OFF")
    ...
    prg.add(4020000, "AOM Probe Amp ch1 (+)", 1000)
    prg.add(4030000, "AOM Probe Amp ch2 (-)", 1000)
    return prg
