...
def program(prg, cmd):
    ...
    prg.add(380542850, "Dipole Evaporation Ramp")
    prg.add(480543350, "Config field OFF")
    prg.add(480544350, "Swich Off Dipole")
    prg.add(480844350, "Picture Na_2Gdet_offset", enable=False)
    prg.add(480844350, "Picture Na_1Gdet_offset", enable=False)
    prg.add(480844350, "Picture Na_offset", enable=False)
    prg.add(480844350, "Picture Na_Shortrepumper_offset")
    prg.add(480844350, "Picture Na_3Gdet_offset", enable=False)
    prg.add(480844350, "Picture Na_4Gdet_offset", enable=False)
    prg.add(484948949, "Initialize_Dipole_Off")
    prg.add(484953949, "Set MOT")
    return prg
