...
def program(prg, cmd):
    ...
    prg.add(272902510, "Picture Na_offset", enable=False)
    prg.add(272902550, "Oscilloscope Trigger ON")
    prg.add(272902550, "Picture Na_Shortrepumper_offset", enable=False)
    prg.add(272902550, "Picture Na_3Gdet_offset", enable=False)
    prg.add(272902550, "Picture Na_4Gdet_offset", enable=False)
    prg.add(277902550, "Initialize_Dipole_Off")
    prg.add(277907550, "Set MOT")
    return prg
def commands(cmd):
    import numpy as np
