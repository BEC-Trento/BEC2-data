...
def program(prg, cmd):
    ...
    prg.add(381562350, "Config field OFF", enable=False)
    prg.add(381562350, "Picture MT to Levit at 0ms - Levit 30 ms")
    prg.add(381562350, "Picture MT to Levit at 0ms - Levit 50 ms", enable=False)
    prg.add(381562350, "Picture MT to Levit at 0ms - Levit variableTime", enable=False)
    prg.add(381565350, "DAC BCompZ", 0.2400)
    prg.add(381565850, "Swich Off Dipole")
    prg.add(381765850, "Picture Na_Shortrepumper_offset", enable=False)
    prg.add(381765850, "Picture Na_2Gdet_offset", enable=False)
    prg.add(381765850, "Picture Na_1Gdet_offset", enable=False)
    prg.add(381765850, "Picture Na_offset", enable=False)
    prg.add(381765850, "Picture Na_Shortrepumper_offset", enable=False)
    prg.add(381765850, "Picture Na_3Gdet_offset", enable=False)
    prg.add(381765850, "Picture Na_4Gdet_offset", enable=False)
    prg.add(401765850, "Initialize_Dipole_Off")
    prg.add(401770850, "Set MOT")
    return prg
