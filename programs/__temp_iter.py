...
def program(prg, cmd):
    ...
    prg.add(218240100, "Config field MT-MOT to Levit")
    prg.add(218241100, "DAC MT-MOT Current", 40.0000)
    prg.add(218241100, "Config field OFF", enable=False)
    prg.add(218241140, "Oscilloscope Trigger OFF")
    prg.add(218242890, "Picture_Mirror_Na_VarProbeDet", functions=dict(time=lambda x: x + cmd.get_var('tof')), enable=False)
    prg.add(218242890, "Picture_Mirror_Levit_VarProbeDet", functions=dict(time=lambda x: x+cmd.get_var('tof')))
