...
def program(prg, cmd):
    ...
    prg.add(276637500, "Config field OFF")
    prg.add(276639100, "Swich Off Dipole")
    prg.add(276789100, "Picture Na_4Gdet", functions=dict(time=lambda x: x + cmd.get_var('TOF'), funct_enable=False), enable=False)
    prg.add(276789100, "Picture Na_4Gdet_hamamatsu", enable=False)
    prg.add(276789100, "Picture Na_resonant_hamamatsu")
    prg.add(276789100, "Picture Na_2Gdet", enable=False)
    prg.add(276789100, "Picture Na_1Gdet", enable=False)
    prg.add(276789100, "Picture Na_0Gdet", enable=False)
    prg.add(281789100, "Set_MOT")
    prg.add(281789100, "Set_BrightMOT", enable=False)
    return prg
def commands(cmd):
    import numpy as np
