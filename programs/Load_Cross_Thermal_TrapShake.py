...
def program(prg, cmd):
    ...
    prg.add(239394859, "Horizontal Dipole Evaporation Ramp_smallBEC", enable=False)
    ...
    prg.add(321896010, "Config field OFF", enable=False)
    prg.add(321896010, "Picture MT to Levit at 0ms - Levit 30 ms", enable=False)
    prg.add(321896010, "Picture MT to Levit at 0ms - Levit 20 ms", enable=False)
    prg.add(321896010, "Picture MT to Levit at 0ms - Levit 5 ms", enable=False)
    prg.add(321896010, "Picture MT to Levit at 0ms - Levit 10 ms", enable=False)
    prg.add(321896010, "Picture MT to Levit at 0ms - Levit 50 ms")
    prg.add(321896010, "Picture MT to Levit at 0ms - Levit variableTime", enable=False)
    prg.add(321899010, "DAC BCompZ", 0.2400, enable=False)
    prg.add(321899510, "Swich Off Dipole")
    prg.add(321902510, "Picture Na_Shortrepumper_offset", enable=False)
    prg.add(321902510, "Picture Na_2Gdet_offset", enable=False)
    prg.add(321902510, "Picture Na_1Gdet_offset", enable=False)
    prg.add(321907510, "Picture Na_offset", enable=False)
    prg.add(321907550, "Oscilloscope Trigger ON")
    prg.add(321907550, "Picture Na_Shortrepumper_offset", enable=False)
    prg.add(321907550, "Picture Na_3Gdet_offset", enable=False)
    prg.add(321907550, "Picture Na_4Gdet_offset", enable=False)
    prg.add(326907550, "Initialize_Dipole_Off")
    prg.add(326912550, "Set MOT")
    return prg
def commands(cmd):
    import numpy as np
