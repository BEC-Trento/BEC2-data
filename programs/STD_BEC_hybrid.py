...
def program(prg, cmd):
    ...
    prg.add(216689600, "Picture Na_4Gdet", functions=dict(time=lambda x: x + cmd.get_var('TOF'), funct_enable=False), enable=False)
    prg.add(216689600, "Picture Na_4Gdet_hamamatsu", enable=False)
    prg.add(216689600, "Picture Na_resonant_hamamatsu", enable=False)
    prg.add(216689600, "Picture Na_2Gdet", enable=False)
    prg.add(216689600, "Picture Na_1Gdet", enable=False)
    prg.add(216689600, "Picture Na_0Gdet", enable=False)
    prg.add(221689600, "Set_MOT")
    prg.add(221789600, "IGBT BCompZfine OPEN")
    prg.add(221789600, "Set_BrightMOT", enable=False)
    return prg
def commands(cmd):
    import numpy as np
