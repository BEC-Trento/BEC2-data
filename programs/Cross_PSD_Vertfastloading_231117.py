...
def program(prg, cmd):
    ...
    prg.add(238955350, "Config field OFF")
    prg.add(238957350, "DAC Horiz IR", -0.1000)
    prg.add(238957850, "AOM IR Horizontal freq", 120.00)
    prg.add(239007850, "Config field OFF", enable=False)
    prg.add(239009850, "Swich Off Dipole")
    prg.add(239009850, "DAC BCompZ", 0.2400, enable=False)
    prg.add(239012850, "Picture Na_Shortrepumper_offset")
    prg.add(239012850, "Picture MT to Levit at 0ms - Levit 20 ms", enable=False)
    prg.add(239012850, "Picture Na_Shortrepumper_2G_offset", enable=False)
    prg.add(239012850, "Picture Na_2Gdet_offset", enable=False)
    prg.add(239012850, "Picture Na_1Gdet_offset", enable=False)
    prg.add(239012850, "Picture Na_offset", enable=False)
    prg.add(239012850, "Picture Na_Shortrepumper_offset", enable=False)
    prg.add(239012850, "Picture Na_ProvaNew_150917", enable=False)
    prg.add(239012850, "Picture Na_3Gdet_offset", enable=False)
    prg.add(239012850, "Picture Na_4Gdet_offset", enable=False)
    prg.add(243117449, "Initialize_Dipole_Off")
    prg.add(243122449, "Set MOT")
    prg.add(2328464300, "AOM IR Vertical freq", 80.00, enable=False)
    return prg
def commands(cmd):
    import numpy as np
